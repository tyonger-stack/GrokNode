...
import { createElectronProductionLocalAccountBinding } from "./source/electron-main/adapters/account-edge.ts";
...
const adapters = {
  ...
  localAccount: createElectronProductionLocalAccountBinding(),
