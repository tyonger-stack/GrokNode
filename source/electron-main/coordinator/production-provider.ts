...
import { createLocalCoordinatorRuntime } from "./local-coordinator-runtime.js";
import {
...
export interface ProductionCoordinatorAuthStatus  {
...
>(ports: ProductionCoordinatorPorts<Status>): ProductionCoordinatorAdapter {
  ...
  let created = false;
  let active:
    | ReturnType<typeof createLocalCoordinatorRuntime>
    | undefined;
  ...
  return {
    create(context) {
      ...
      const localRuntime = createLocalCoordinatorRuntime(createRuntime);
      active = localRuntime;
      ...
      return {
        ...
        async dispose() {
          ...
          disposed = true;
          prompt.finish();
          if (active === localRuntime) active = undefined;
