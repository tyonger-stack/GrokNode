...
export const ELECTRON_PRODUCTION_AREA_EVIDENCE = Object.freeze({
  ...
  localAccount: {
    recoveredProviders: ["source/electron-main/adapters/account-edge.ts", "source/electron-main/account/stepfun-transcribe.ts"],
  ...
  updaterInstaller: {
    recoveredProviders: ["source/electron-main/update/update-wiring.ts", "source/electron-main/update/sand-update-service.ts"],
  ...
  accountOAuth: {
    recoveredProviders: ["source/electron-main/adapters/account-oauth.ts"],
    injectedPorts: ["local logged-out account state"],
  },
  experiments: {
...
export interface ElectronProductionAdapterBindings {
  ...
  readonly attachmentGateway: {
    create(context: Omit<ProductionServiceContext, "attachments" | "avatarImages" | "localAccount" | "ensureTranscriptionManager">): unknown;
  };
...
export function createElectronProductionServiceFactories(
  ...
  const requirements: Readonly<Record<keyof ElectronProductionAdapterBindings, readonly string[]>> = {
    secureStorage: ["initialize", "getMachineId"], settings: ["create"], attachmentGateway: ["create"], avatarImages: ["create"], localAccount: ["create", "createTranscriptionManager"], mainRpc: ["create"],
  ...
  return {
    ...
    createLocalAccount: (context) => adapters.localAccount.create(context),
    createTranscriptionManager: (context) => adapters.localAccount.createTranscriptionManager(context),
