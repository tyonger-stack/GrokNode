...
export interface HostSettingsUpdate {
  ...
  openRouterModel?: string | null; openRouterBaseUrl?: string | null; openRouterEffort?: string | null; openRouterChatStatus?: OpenRouterChannelStatus | null;
}
...
export class SettingsService {
  ...
  setHostSettings(update: HostSettingsUpdate) {
    ...
    if (update.localMcpServers !== undefined) this.store.setLocalMcpServers(update.localMcpServers);
    ...
    if (update.openRouterEffort !== undefined) { this.store.setOpenRouterEffort(update.openRouterEffort === null || update.openRouterEffort.trim().length === 0 ? null : update.openRouterEffort.trim()); }
    if (update.openRouterChatStatus !== undefined) { const normalized = normalizeOpenRouterChannelStatus(update.openRouterChatStatus); if (normalized != null) this.store.setOpenRouterChatStatus(normalized); }
  ...
  getLocalMcpServers(): Record<string, McpServerConfig> { return this.store.getLocalMcpServers(); }
  setLocalMcpServers(servers: Record<string, McpServerConfig>): void { this.store.setLocalMcpServers(servers); }
