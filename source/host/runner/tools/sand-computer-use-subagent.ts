...
import { createSandBrowserUseSubagentConfig } from "./sand-browser-use-subagent.js";
...
export function builtinSubagentConfigs(isRemoteBoxAvailable: boolean): readonly unknown[] {
  if (!isRemoteBoxAvailable) return [];
  return [
    createSandComputerUseSubagentConfig({ browserUseOffered: true }),
