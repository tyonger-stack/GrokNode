...
function addSmartModeApprovalParameters(
  ...
  return parameters.extend({
    request_smart_mode_approval: z.preprocess(
      (value) => value === "true" ? true : value === "false" ? false : value,
      z.boolean(),
    ).optional().describe(REQUEST_SMART_MODE_APPROVAL_DESCRIPTION),
...
export function createShellTool(resourceAccessor: ShellToolResourceAccessor, options: ShellToolOptions = {}): ReturnType<typeof createZodAgentTool> | undefined {
  ...
  const smartModeApprovalParametersEnabled = options.smartModeApprovalProvider !== undefined && options.smartModeClassifierMode === true;
