...
export const DESKTOP_BRIDGE_TOP_LEVEL_KEYS = [
  ...
  "onDeepLink", "botTemplates", "deepLinksReady", "getBoxMigrationStatus", "onBoxMigration",
  "onDevBoxRebuild", "onOpenFeedback", "onOpenAbout", "submitFeedback", "onWidgetGallery",
  "onForceOnboarding", "transcribeAudio", "account", "experiments", "platform", "isDev",
...
export interface AccountDesktopBridge {
...
export interface DesktopBridge {
  ...
  readonly account: AccountDesktopBridge;
